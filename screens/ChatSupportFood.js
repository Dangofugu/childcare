...
const ChatSupportFood = ({ navigation }) => {
  const onPressMobileNumberClick = () => {
    let phoneNumber = '';
    phoneNumber = `tel:${'+255682729800'}`;
    ...
    <View style={styles.container}>
        ...
        <View
          ...
          <View style={{ flexDirection: 'row' }}>
            ...
            <View
              ...
              <Text style={{ ...FONTS.h3 }}>Dr. Vincent Samadu</Text>
          ...
          <View style={{ marginTop: SIZES.radius }}>
            <Text style={{ color: COLORS.gray, ...FONTS.body3 }}>
              Get support from our professional
            </Text>
          </View>
        </View>
      ...
      <View style={{ flex: 1.5 }}>
        ...
        <View
          ...
          <IconLabel icon={icons.childfood} label="Food" />
        ...
        <View
          ...
          <Text
            ...
            He is a medical doctor and a professional expert on children's
            diseases as he became a good adviser on food and dieting . He
            attended his bachelor degree at St Joseph Univesity
          </Text>
        </View>
      </View>
        ...
        <LinearGradient
          ...
          <View style={{ flex: 1, flexDirection: 'row', alignItems: 'center' }}>
            <View
              ...
              <Text style={{ ...FONTS.h3 }}>+255682729800</Text>
            </View>
...
export default ChatSupportFood;
