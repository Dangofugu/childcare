...
const ChatSupportIllness = ({ navigation }) => {
  const onPressMobileNumberClick = () => {
    let phoneNumber = '';
    phoneNumber = `tel:${'+255677820374'}`;
    ...
    <View style={styles.container}>
        ...
        <View
          ...
          <View style={{ flexDirection: 'row' }}>
            ...
            <View
              ...
              <Text style={{ ...FONTS.h3 }}>Dr. Upendo Narsis Liana</Text>
      ...
      <View style={{ flex: 1.5 }}>
        ...
        <View
          ...
          <IconLabel icon={icons.childillness} label="Illness" />
        ...
        <View
          ...
          <Text
            ...
            She is a medical doctor, also she specialized on dealing with
            children's diseases. She attended her first degree at Bugando
            University Mwanza.
          </Text>
        </View>
      </View>
        ...
        <LinearGradient
          ...
          <View style={{ flex: 1, flexDirection: 'row', alignItems: 'center' }}>
            <View
              ...
              <Text style={{ ...FONTS.h3 }}>+255677820374</Text>
            </View>
...
export default ChatSupportIllness;
